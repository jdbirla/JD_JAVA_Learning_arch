package com.jd.java.membermodifiers.nonaccess;
...
public class StaticModifierExamples {
	...
	public static void main(String[] args) {
		...
		Dog god1 = new Dog();
		god1.StaticMethod();// Animal Static Method
		
		Animal animal2 = new Dog();
		animal2.nonStaticMethod();// Animal Static Method
		
		Dog god2 = new Dog();
		god2.nonStaticMethod();// Animal Static Method
