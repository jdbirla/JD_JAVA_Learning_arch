...
class MyList {
	...
	public String toString() {
		return String.format("MyList [values=%s]", values);
	}
...
public class GenericsExamples3 {
	...
	public static void main(String[] args) {
		...
		myListString.add("Value 2");
		 System.out.println("myListString :"+myListString.toString());

		MyListGeneric<Integer> myListInteger = new MyListGeneric<Integer>();
		myListInteger.add(1);
		myListInteger.add(2);
		 System.out.println("myListInteger :"+myListInteger.toString());
		...
		restrictedListInteger.add(2);
		 System.out.println("restrictedListInteger :"+restrictedListInteger.toString());
